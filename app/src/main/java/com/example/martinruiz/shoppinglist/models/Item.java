...
import com.example.martinruiz.shoppinglist.activities.MainActivity;
...
public class Item extends RealmObject {
    ...
    public Item(String name,Category category, double price, String imageURL, int quantity, String note) {
